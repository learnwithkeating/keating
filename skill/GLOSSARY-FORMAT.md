...
A 1–10 self-rating of how hard a set felt, where 10 is failure and 8 means two
...
- **The user drafts every definition first, from memory.** Compressing a concept
  into a tight definition is itself the evidence of understanding - so the
  compressing must be theirs. The agent critiques the draft (what it has, what
  it misses, what it subtly gets wrong) and the entry is finalized in the user's
